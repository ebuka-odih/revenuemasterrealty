                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h3 class="nk-block-title page-title">Fund User</h3>
                                        ...
                                        <div class="card card-bordered h-100">
                                            <div class="card-inner">
                                                <form action="{{ route('admin.funding.store') }}" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-label" for="full-name">Funding Type</label>
                                                        <div class="form-control-wrap">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="number" name="amount" class="form-control" id="email-address">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
